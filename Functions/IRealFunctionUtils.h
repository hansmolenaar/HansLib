...
// std::shared_ptr< IMultiVariableRealValuedFunction> operator-(const IMultiVariableRealValuedFunction&, const
// IMultiVariableRealValuedFunction&); std::shared_ptr< IMultiVariableRealValuedFunction> operator/(const
// IMultiVariableRealValuedFunction&, const IMultiVariableRealValuedFunction&);
