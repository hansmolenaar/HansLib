...
void ISingleVariableRealValuedFunctionUtils::ToFile(const ISingleVariableRealValuedFunction &fie, double xmin,
                                                    double xmax, int nPoints, const std::string &functionName)
{
...
void ISingleVariableRealValuedFunctionUtils::ToFile(const ISingleVariableRealValuedFunction &expect,
                                                    const ISingleVariableRealValuedFunction &approximate, double xmin,
                                                    double xmax, int nPoints, const std::string &functionName)
{
    Utilities::MyAssert(nPoints > 1);
    Utilities::MyAssert(xmax > xmin);
