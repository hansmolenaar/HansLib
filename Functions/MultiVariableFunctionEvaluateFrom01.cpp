...
MultiVariableFunctionEvaluateFrom01::MultiVariableFunctionEvaluateFrom01(
    std::shared_ptr<IMultiVariableFunctionEvaluate> fie, std::vector<Interval<double>> &&targetIntervals)
