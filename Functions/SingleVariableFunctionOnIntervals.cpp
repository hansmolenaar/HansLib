...
SingleVariableFunctionOnIntervals::SingleVariableFunctionOnIntervals(std::vector<std::shared_ptr<SingleVariableFunctionOnInterval>> fies, double defaultOutsideIntervals) :
