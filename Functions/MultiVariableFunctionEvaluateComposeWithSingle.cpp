...
MultiVariableFunctionEvaluateComposeWithSingle::MultiVariableFunctionEvaluateComposeWithSingle(std::shared_ptr<ISingleVariableRealValuedFunction> transform, std::shared_ptr<IMultiVariableFunctionEvaluate> function) :
