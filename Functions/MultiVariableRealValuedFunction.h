...
{
  public:
    MultiVariableRealValuedFunction(std::vector<bool> isactive, std::function<double(std::span<const double>)>,
...
MultiVariableRealValuedFunction operator-(const IMultiVariableRealValuedFunction &,
                                          const IMultiVariableRealValuedFunction &);
MultiVariableRealValuedFunction operator/(const IMultiVariableRealValuedFunction &,
                                          const IMultiVariableRealValuedFunction &);
