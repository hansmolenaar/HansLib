...
{
  public:
    SingleVariableFunctionOnInterval(std::shared_ptr<ISingleVariableRealValuedFunction>,
                                     const Interval<double> &domain);
    static std::shared_ptr<SingleVariableFunctionOnInterval> CreateLinearOnInterval(const Interval<double> intv,
                                                                                    double valL, double valR);
