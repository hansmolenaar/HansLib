...
{
  public:
    SingleVariableFunctionOnIntervals(std::vector<std::shared_ptr<SingleVariableFunctionOnInterval>> fies,
                                      double defaultOutsideIntervals = std::numeric_limits<double>::quiet_NaN());
