...
namespace
{
   ...
   void CheckCalculationSingleMatrix(const MatrixKelvinRepr3& matrix, const std::span<const double>& expectedSortedEigenValues, const bool checkDerivatives, const double del)
   {
