...
{
    // 2 * x^2 * y^3
    auto fie = MultiVariableFunctionExamples::GetPolynomial(
        std::vector<std::pair<std::vector<int>, double>>{{std::make_pair(std::vector<int>{2, 3}, 2.0)}});
    const MultiVariableFunctionEvaluateFrom01 scaled(
