...
TEST(SingleVariableFunctionsOnInterval, Simple)
{
	...
	const SingleVariableFunctionOnIntervals function(std::vector <std::shared_ptr<SingleVariableFunctionOnInterval>> {function1, function2}, 999.0);
...
TEST(SingleVariableFunctionsOnInterval, exception)
{
	...
	auto monomial1 = std::make_shared<SingleVariableMonomial>(1);
	auto function1 = std::make_shared< SingleVariableFunctionOnInterval>(monomial1, domain1);
	const SingleVariableFunctionOnIntervals function(std::vector <std::shared_ptr<SingleVariableFunctionOnInterval>> {function1});
