...
TEST(GroupFromOrbitTest, Trivial)
{
    ...
    const auto retval = GroupFromOrbit::Create<1>(areClose, transformations, Point1{3.0});
...
TEST(GroupFromOrbitTest, Rotate4)
{
    ...
    const auto retval = GroupFromOrbit::Create<2>(areClose, transformations, Point2{1, 0});
...
TEST(GroupFromOrbitTest, Di3)
{
    ...
    const auto retval = GroupFromOrbit::Create<2>(areClose, transformations, Point2{1, 2});
    ASSERT_TRUE(retval);
