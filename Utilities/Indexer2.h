...
template <typename T> class Indexer2
{
  public:
...
template <typename T> size_t Indexer2<T>::ToFlat(T i, T j)
{
...
template <typename T> std::array<T, 2> Indexer2<T>::FromFlat(size_t flat)
{
