...
void ML::AnnLayerUniform::setActivatorFunction(std::span<const double> weightedAverage,
                                               std::span<double> activatorValues) const
{
    Eval(m_size, weightedAverage, activatorValues, m_function);
}

void ML::AnnLayerUniform::setActivatorFunctionDeriv(std::span<const double> weightedAverage,
                                                    std::span<double> activatorDerivValues) const
{
