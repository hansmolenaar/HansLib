...
namespace ML
{
   namespace IAnnModelUtils
   {
      ...
      void setErrors(const IAnnModel& model, const ML::IFeedForwardResult& forwardResult, std::span<const double> ideal, const ML::IParameterSet& parameters, ML::IParameterSet& parameterDerivs);
