...
class AnnLayerUniform : public ML::IAnnLayer
{
  public:
    ...
    void setActivatorFunction(std::span<const double> weightedAverage,
                              std::span<double> activatorValues) const override;
    void setActivatorFunctionDeriv(std::span<const double> weightedAverage,
                                   std::span<double> activatorDerivValues) const override;
