...
void ML::AnnWeightsWithBias::setActivation(std::span<const double> outputPrv, std::span<const double> params,
                                           std::span<double> activation) const
{
    ...
    std::transform(activation.begin(), activation.end(), bias.begin(), activation.begin(),
                   [](double x, double y) { return x + y; });
}

void ML::AnnWeightsWithBias::backpropagateError(std::span<const double> errorCur, std::span<const double> params,
...
void ML::AnnWeightsWithBias::backpropagateParamDeriv(std::span<const double> errorCur,
