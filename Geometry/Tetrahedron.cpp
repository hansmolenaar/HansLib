...
std::array<Point3, Topology::NumNodesOnTetrahedron> Tetrahedron::getRegularTetrahedron()
{
   return { Point3{1,1,1}, Point3{1,-1, -1}, Point3{-1, -1, 1}, Point3{-1, 1, -1} };
}

std::array<Point3, Topology::NumNodesOnTetrahedron> Tetrahedron::getTriRectangularTetrahedron(double a, double b, double c)
{
...
{
   return getSmallestDihedralAngle(std::array<Point3, NumNodesOnTetrahedron>{p0, p1, p2, p3});
}
...
double Tetrahedron::getSmallestDihedralAngle(const std::array<Point3, Topology::NumNodesOnTetrahedron>& vert)
{
   ...
   for (size_t f0 = 0; f0 < NumNodesOnTetrahedron - 1; ++f0)
   {
      for (size_t f1 = f0 + 1; f1 < NumNodesOnTetrahedron; ++f1)
      {
