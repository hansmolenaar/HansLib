...
{
   template<typename T>
   class Sphere3AsManifold2 : public IManifold2<T>
   {
   ...
   public:
      ...
      DirectedEdgeIntersections<T, GeomDim3>  getIntersections(const DirectedEdge<T, GeomDim3>& edge, const IGeometryPredicate<T, GeomDim3>& predicate) const override;
