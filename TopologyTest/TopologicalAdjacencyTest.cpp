...
{
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Edge, 1, Topology::Corner, 1,
                                                  std::map<int, std::vector<int>>{{0, std::vector<int>{1, 0}}}));
}

TEST(TopologicalAdjacencyTest, error2)
{
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Edge, 0, Topology::Corner, 2,
                                                  std::map<int, std::vector<int>>{{0, std::vector<int>{1, 0}}}));
}
...
{
    const std::map<int, std::vector<int>> adj{{0, std::vector<int>{1, 0}}};
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Corner, 1, Topology::Corner, 1,
                                                  std::map<int, std::vector<int>>{{0, std::vector<int>{1, 0}}}));
}

TEST(TopologicalAdjacencyTest, error4)
{
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Edge, 1, Topology::Corner, 2,
                                                  std::map<int, std::vector<int>>{{0, std::vector<int>{1, 1}}}));
}

TEST(TopologicalAdjacencyTest, error5)
{
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Edge, 1, Topology::Corner, 2,
                                                  std::map<int, std::vector<int>>{{1, std::vector<int>{0, 1}}}));
}

TEST(TopologicalAdjacencyTest, error6)
{
    ASSERT_ANY_THROW(TopologicalAdjacency::Create(Topology::Edge, 1, Topology::Corner, 2,
                                                  std::map<int, std::vector<int>>{{0, std::vector<int>{0, 2}}}));
}