...
TEST(ReferenceShapeHyperCubeTest, Edge)
{
   ...
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Corner), 2);
...
TEST(ReferenceShapeHyperCubeTest, Square)
{
   ...
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Edge), 4);
...
TEST(ReferenceShapeHyperCubeTest, Cube)
{
   ...
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Corner), 8);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Edge), 12);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Face), 6);
...
TEST(ReferenceShapeHyperCubeTest, Tesseract)
{
   ...
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Corner), 16);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Edge), 32);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Face), 24);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Volume), 8);
...
TEST(ReferenceShapeHyperCubeTest, Penteract)
{
   ...
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Corner), 32);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Edge), 80);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Face), 80);
   ASSERT_EQ(adjacencies.getCount(TopologyDimensionDef::Volume), 40);
   ASSERT_EQ(adjacencies.getCount(4), 10);
