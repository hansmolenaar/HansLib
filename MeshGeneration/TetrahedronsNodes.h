...
class TetrahedronsNodes
{
  public:
    ...
    // boost::container::static_vector<CellIndex, Topology::NumCornersOnTetrahedron>
    // getEdgeConnectedTetrahedrons(CellIndex TetrahedronId) const;
    boost::container::static_vector<CellIndex, Topology::NumCornersOnTetrahedron> getCommonNodes(
        CellIndex tetId1, CellIndex tetId2) const;
    std::vector<Topology::NodeIndex> getEdgeConnectedNodes(Topology::NodeIndex node) const;
    std::optional<CellIndex> tryGetTetrahedronFromOrientedNodes(
        const std::array<Topology::NodeIndex, Topology::NumCornersOnTetrahedron> &nodes) const;
    std::optional<CellIndex> tryGetTetrahedronFromNodes(
        std::array<Topology::NodeIndex, Topology::NumCornersOnTetrahedron> nodes) const;
