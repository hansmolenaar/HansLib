...
class Manifold1Reconstruction : public IManifoldReconstruction
{
  public:
    ...
    Manifold1Reconstruction(const Geometry::IManifold1D2<GeomType> &manifold,
                            const ManifoldsAndNodes<GeomDim2> &manifoldsAndNodes, const TrianglesNodes &trianglesNodes);
