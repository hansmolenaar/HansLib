...
TEST(TetrahedronsNodesTest, GetAllEdges)
{
   ...
   const std::vector<EdgeNodesSorted> expect{EdgeNodesSorted(0, 1),  EdgeNodesSorted(0, 42),  EdgeNodesSorted(0, 999),
                                             EdgeNodesSorted(1, 42), EdgeNodesSorted(1, 999), EdgeNodesSorted(42, 999)};
