...
TEST(ManifoldsAndNodesTest, Delete)
{
    ...
    ASSERT_MYEXCEPTION_MESSAGE(manifoldsAndNodes.deleteNode(1),
                               "ManifoldsAndNodes<N>::deleteNode unknown node specified");
...
TEST(ManifoldsAndNodesTest, IsMobileTwoCornerManifolds)
{
    const Manifold0<GeomType, GeomDim2> pointManifold1(Point2{1, 2},
                                                       "ManifoldsAndNodesTest_IsMobileTwoCornerManifolds_1");
    const Manifold0<GeomType, GeomDim2> pointManifold2(Point2{2, 1},
                                                       "ManifoldsAndNodesTest_IsMobileTwoCornerManifolds_2");
...
TEST(ManifoldsAndNodesTest, nodeIn2Manifolds)
{
    ...
    ASSERT_MYEXCEPTION_MESSAGE(manifoldsAndNodes.addNodeToManifold(node, &pointManifold2),
                               "Try to add node 42 to manifold bar; it is already in foo");
}
