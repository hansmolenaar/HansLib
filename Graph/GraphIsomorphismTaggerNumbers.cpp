...
std::weak_ordering TaggerNumbers::compareCharacteristics(const ICharacteristicsCompare &otherComparer) const
{
    const auto &other = dynamic_cast<const TaggerNumbers &>(otherComparer);
