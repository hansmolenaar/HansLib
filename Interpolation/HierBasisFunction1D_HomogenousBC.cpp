...
HierBasisFunction1D_HomogenousBC::HierBasisFunction1D_HomogenousBC(HierLevelIndex levelIndex) : m_levelIndex(levelIndex)
{
...
std::unique_ptr<HierBasisFunction1D_HomogenousBC> HierBasisFunction1D_HomogenousBC_Factory::create(
