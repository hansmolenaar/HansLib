...
namespace
{
CompareTaggedGraphFactory compareTaggedGraphFactory;
...
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_3(), Tag{1, 4});
}

TEST(GraphIsomorphismTaggedGraphTest, CheckTaggingList4)
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_4(), Tag{1, 11});
}

TEST(GraphIsomorphismTaggedGraphTest, CheckTaggingList5)
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_5(), {1, 34});
}

TEST(GraphIsomorphismTaggedGraphTest, CheckTaggingList6)
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_6(), {1, 155});
}

TEST(GraphIsomorphismTaggedGraphTest, CheckTaggingList7)
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_7(), {1, 298, 2, 2});
}

TEST(GraphIsomorphismTaggedGraphTest, CheckTaggingList8)
{
    GraphTest::CheckList(compareTaggedGraphFactory, UndirectedGraphFromG6::getListNumVertices_8(), {1, 722, 2, 12});
}
...
TEST(GraphIsomorphismConstructTest, Disconnected5)
{
    ...
    GraphTest::CheckList(compareTaggedGraphFactory, graphs, {1, 13});
}
...
TEST(GraphIsomorphismTaggedGraphTest, Disconnected6)
{
    ...
    GraphTest::CheckList(compareTaggedGraphFactory, graphs, {1, 43});
}
...
TEST(GraphIsomorphismTaggedGraphTest, Disconnected7)
{
    ...
    GraphTest::CheckList(compareTaggedGraphFactory, graphs, {1, 35});
}
...
TEST(GraphIsomorphismTaggedGraphTest, Disconnected8)
{
    ...
    GraphTest::CheckList(compareTaggedGraphFactory, graphs, {1, 17});
}
...
TEST(GraphIsomorphismTaggedGraphTest, Disconnected9)
{
    ...
    GraphTest::CheckList(compareTaggedGraphFactory, graphs, {1, 18});
}
