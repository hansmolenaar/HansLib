...
template <size_t N>
static void TestTryGetClosePoints(const std::vector<Point<double, N>> closePoints,
                                  const UniquePointCollectionBinning<N> collection)
{
    // Check pairs
...
TEST(UniquePointCollectionBinningTest, TryGetClosePoint4)
{
    ...
    const UniquePointCollectionBinning<GeomDim2> collection(
        predicate, std::vector<Point2>{Point2{0, 2}, Point2{1, 3}, Point2{1, 2}, Point2{0, 3}, Point2{0.2, 1.4}});
