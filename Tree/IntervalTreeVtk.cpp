...
template <> std::unique_ptr<Vtk::VtkData> IntervalTree::GetVtkData(const IndexTree<1> &tree, const Vtk::Name &name)
{
    return getVtkData(tree, Vtk::CellType::VTK_LINE, name);
}

template <> std::unique_ptr<Vtk::VtkData> IntervalTree::GetVtkData(const IndexTree<2> &tree, const Vtk::Name &name)
{
    return getVtkData(tree, Vtk::CellType::VTK_QUAD, name);
}

template <> std::unique_ptr<Vtk::VtkData> IntervalTree::GetVtkData(const IndexTree<3> &tree, const Vtk::Name &name)
{
