...
TEST(TartanGridTest, 1D)
{
   ...
   ASSERT_EQ(grid.getTopology().getMaxTopologyDimension(), Topology::Edge);
   ASSERT_EQ(grid.getTopology().getCountSafe(Topology::Edge), 2);
   ASSERT_EQ(grid.getTopology().getCountSafe(Topology::Corner), 3);
...
TEST(TartanGridTest, 2D)
{
   ...
   ASSERT_EQ(grid.getTopology().getMaxTopologyDimension(), Topology::Face);
   ASSERT_EQ(grid.getTopology().getCountSafe(Topology::Face), 6);
   ASSERT_EQ(grid.getTopology().getCountSafe(Topology::Corner), 12);
