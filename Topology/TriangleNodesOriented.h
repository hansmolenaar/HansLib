...
class TriangleNodesOriented
{
  public:
    ...
    auto begin() const
    {
        return m_triangle.begin();
    }
    auto end() const
    {
        return m_triangle.end();
    }
    auto operator<=>(const TriangleNodesOriented &other) const
    {
        return m_triangle <=> other.m_triangle;
    };
    auto operator==(const TriangleNodesOriented &other) const
    {
        return m_triangle == other.m_triangle;
