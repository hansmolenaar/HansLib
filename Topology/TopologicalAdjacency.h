...
{
  public:
    static std::unique_ptr<TopologicalAdjacency> Create(TopologyDimension, int, TopologyDimension, int,
  ...
  private:
    TopologicalAdjacency(TopologyDimension, std::map<int, std::vector<int>> &&, TopologyDimension,
                         const std::map<int, std::vector<int>> &&);
