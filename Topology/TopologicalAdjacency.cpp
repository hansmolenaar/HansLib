...
TopologicalAdjacency::TopologicalAdjacency(TopologyDimension dimLow, std::map<int, std::vector<int>> &&low2high,
                                           TopologyDimension dimHigh, const std::map<int, std::vector<int>> &&high2low)
    : m_dimLow(dimLow), m_dimHigh(dimHigh), m_low_2_high(low2high), m_high_2_low(high2low)
{
}
