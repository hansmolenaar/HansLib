...
TEST(HierarchicalBasisFunction1D, Basis_0_0)
{
   ...
   ASSERT_NEAR(fie(-0.1), 0.0, Epsilon);
   ...
   ASSERT_NEAR(fie(1.1), 0.0, Epsilon);
}
...
TEST(HierarchicalBasisFunction1D, Basis_0_1)
{
   ...
   ASSERT_NEAR(fie(0.25), 0., Epsilon);
   ASSERT_NEAR(fie(0.5), 0.0, Epsilon);
...
TEST(HierarchicalBasisFunction1D, Basis_3_5)
{
   ...
   ASSERT_NEAR(fie(0.0), 0.0, Epsilon);
   ASSERT_NEAR(fie(4.0 / 8.0), 0.0, Epsilon);
   ASSERT_NEAR(fie(4.5 / 8.0), 0.5, Epsilon);
   ASSERT_NEAR(fie(5.0 / 8.0), 1.0, Epsilon);
   ASSERT_NEAR(fie(5.5 / 8.0), 0.5, Epsilon);
   ASSERT_NEAR(fie(6.0 / 8.0), 0.0, Epsilon);
   ASSERT_NEAR(fie(1.0), 0.0, Epsilon);
}
